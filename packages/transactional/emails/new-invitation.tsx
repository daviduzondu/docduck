...
export async function invitationEmailHtml(
     ...
     >
      ...
      <div style={{ textAlign: 'left' }}>
       ...
       <Text className="text-base">
        Hello! {inviterName} has invited you to collaborate on the document "
        {documentTitle}".
       </Text>

       <Text className="text-base">
        Click the button below to accept the invitation and start collaborating
        in real time with {inviterName} and others.
       </Text>
      </div>
      ...
      <Text className="text-left text-base">
       If the button doesn’t work or for some weird reason doesnt render
       properly, copy and paste this link into your browser:{' '}
       <span className="text-blue-600">{inviteUrl}</span>
      </Text>
