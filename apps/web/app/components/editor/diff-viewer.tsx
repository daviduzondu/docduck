...
export default function Diff() {
 ...
 const getSnapshotByIdQuery = useQuery(
  orpc.documents.getSnapshotById.queryOptions({
   input: {
 ...
 if (getSnapshotByIdQuery.isPending)
  return (
