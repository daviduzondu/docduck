...
*/
-- CreateIndex
CREATE UNIQUE INDEX "unique_active_document_invitation_index" ON "document_invitations"("email", "documentId") WHERE (("status" = 'PENDING' OR "status" = 'ACCEPTED') AND "revokedAt" IS NULL );
