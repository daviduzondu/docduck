...
*/
-- DropForeignKey
ALTER TABLE "document_invitations" DROP CONSTRAINT "document_invitations_documentId_fkey";

-- DropForeignKey
ALTER TABLE "document_invitations" DROP CONSTRAINT "document_invitations_inviterId_fkey";
