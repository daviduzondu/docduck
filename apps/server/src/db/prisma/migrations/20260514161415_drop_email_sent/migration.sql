/*
  ...
  - You are about to drop the column `emailSent` on the `document_invitation` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "document_invitation" DROP COLUMN "emailSent";
